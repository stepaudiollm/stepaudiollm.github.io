...
const productCopy = Object.freeze({
  zh: {
    ...
    modelKicker: "模型介绍",
    modelTitle: "让语音更具真人感。",
    modelSummary: "从<strong>真人感 TTS</strong>与<strong>音色设计</strong>，到歌声、音效与音乐，在统一框架中生成多种声音。",
    modelLead: "StepAudio 3 Gen 是采用<strong>全离散自回归架构</strong>的通用音频生成模型，在 TTS 与音色设计任务中展现出突出的真人感与声音控制能力，同时支持歌声、音效、音乐及多类型音频混合生成。模型将语义与声学特征编码为<strong>统一的 RVQ 表征</strong>，让不同类型的声音共享同一套生成框架。",
    modelDetail: "主干模型沿时间轴自回归预测第一层码本，再由轻量级因果 Transformer 补全其余码本。结合 RVQ Adaptor、渐进式预训练、多任务指令训练与监督微调，模型在保留语言能力的同时学习多种音频生成能力，兼顾语义内容、声音表现与声学细节。",
  ...
  en: {
    ...
    ttsVoice5: "Lilt",
    ttsCase5: "On hold with another AI",
    ttsVoice6: "American Ease",
    ttsCase6: "My budget folded first",
    ...
    modelTitle: "Speech that feels human.",
    modelSummary: "From <strong>human-like TTS</strong> and <strong>voice design</strong> to vocals, sound effects, and music—all within a unified generation framework.",
    modelLead: "StepAudio 3 Gen is a general-purpose audio generation model built on a <strong>fully discrete autoregressive architecture</strong>. It delivers strong human-likeness and voice control in TTS and voice design, while supporting vocals, sound effects, music, and mixtures of multiple audio types. A <strong>shared RVQ representation</strong> jointly encodes semantic and acoustic features, bringing these audio domains into one generation framework.",
    modelDetail: "The backbone predicts the first codebook autoregressively along the time axis, while a lightweight causal Transformer completes the remaining codebooks. RVQ Adaptor, progressive pre-training, multi-task instruction training, and supervised fine-tuning build audio generation capabilities while preserving language abilities, modeling semantic content, vocal expression, and acoustic detail together.",
    ...
    caseDescription: 'Describe what you imagine to generate speech, singing, sound effects, and music.',
    ...
    voiceDescription: 'Shape distinctive voices through timbre and emotion. Describe genre and vocal style to create expressive singing.',
...
const presetCopy = Object.freeze({
  ...
  ttsResult5: {"title": ["AI客服趣谈生成结果", "On hold with another AI generated speech"]},
  ttsRef6: {"title": ["美式漫谈参考语音", "American Ease reference"]},
  ttsResult6: {"title": ["折叠屏与钱包生成结果", "My budget folded first generated speech"]},
  ...
  nightFoodStall: { title: ['夏夜大排档', 'Summer Night Food Stall'], detail: ['微醺状态 / 爆炒声 / 江湖气', 'Tipsy delivery / Wok flare / Street-side energy'] },
