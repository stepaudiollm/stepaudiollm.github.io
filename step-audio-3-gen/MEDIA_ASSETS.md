...
The TTS showcase presents 11 named voices and generated speech; no reference-audio players are displayed. The separate Voice Design carousel contains six examples. Four Vocal cards present The Warmth of Goodbye (Chinese male), Coconut Afternoon (English female), Home Is Fine (English female), and Be Well (Chinese female). The vocal gallery uses original illustrated covers. The added Be Well recording is distributed without transcoding.
