window.CONTEXTUAL_TTS_PAGE_DATA = {
  hero: {
    ...
    description:
      "我们正在重新定义语音合成的边界——不止于“复现声音”，更在于“创造表达”，我们构建了一个真正理解人类意图的语音生成模型。在这里，每个声音都可以被赋予灵魂、情绪与故事...",
    features: [
      {
        title: "Zero-shot",
        body:
          "本模型支持基于参考音频的音色复刻，并允许用户在还原音色基础上对声音表达进行灵活控制。用户不再受限于固定音库或预设角色，可在保留音色特征的同时，自定义情感、风格与表现力，实现真正自由、可塑的语音生成。"
      },
      {
        title: "全局语境控制",
        body:
          "一段话，定下一整段话的“魂”。支持用自然语言描述整体语境——无论是故事背景、人物心境，还是情绪基调与表达逻辑，模型都能精准理解并贯穿始终，实现从“文字到声音”到“意图到声音”的跨越。"
      },
      {
        title: "文中语境控制",
        body: 
          "支持用自然语言指挥声音的每一处细节。可直接通过描述来设定情绪、语气、节奏、呼吸乃至角色与场景氛围，还能精细调整情绪层次、句间逻辑与表达意图，甚至刻画心理活动与潜台词。模型可理解语言的流动与未言之意，从而生成主次分明、自然逼真的语音表达。"
        }
    ],
    keywords: [
      { name: "零样本音色复刻", note: "" },
  ...
  sections: {
      ...
      description:
        {
          ...
          items: [
            "基于同一先进模型架构，无需重新训练，即可满足从沉浸式有声书到专业影视配音的全场景高品质语音生成需求。",
            "通过多场景适配能力，我们将专业语音制作的门槛降至最低，让每个用户都能获得“量身定制”的场景化语音解决方案。"
          ]
        },
      cases: [
        {
      ...
      description:
        {
          ...
          highlightFirst: false,
          items: [
            "我们不是简单地复刻音色，而是通过我们的指导，为每个音色构建完整的“声音角色档案”，实现从声纹到人格的全面提升。",
            "我们让每个声音都能拥有深度、让每个角色都能真正“活”起来，为沉浸式内容创作提供前所未有的可能性。"
          ]
        },
      cases: [
        {
    ...
    global: {
      ...
      description:
        [
          "同一音色，同一段文本，在不同全局语境的指引下能演绎出截然不同的生命。",
          "通过输入一段对场景背景与整体情绪基调的自然语言描述，模型便能精准理解您设想的“氛围”，生成情绪统一、风格一致的语音。",
        ],
      promptGroups: [
        {
          id: "global-group-1",
    ...
    local: {
      ...
      title: "一人多面: 全局语境 + 文中语境两档控制能力",
      scriptLabel: "Script + Inline Context",
      description:
        {
          type: "nested-list",
          intro: [
            "全局语境控制整体基调，文中语境雕琢每处细节，实现从宏观风格到微观韵律的精准协同控制，实现真正“一人千面”的深度语音控制。",
            "模型深度理解语义意图，动态适应上下文关系，在多层次韵律与情感参数映射中实现自然流畅的表达。",
            "呼吸节奏、气声哽咽、音色微变等副语言特征智能生成，让合成语音充满符合生理规律的鲜活真实感。"
          ],
          groups: []
        },
      promptGroups: [
